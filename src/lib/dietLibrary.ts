...
export const STAPLES: Staple[] = [
  ...
  { name: 'salmon', group: 'protein', tokens: ['fish', 'animal_flesh'], regions: ['mediterranean', 'east_asian', 'chinese'] },
  { name: 'white fish (cod/tilapia)', group: 'protein', tokens: ['fish', 'animal_flesh'] },
  { name: 'shrimp', group: 'protein', tokens: ['shellfish', 'animal_flesh'], regions: ['east_asian', 'chinese', 'latin'] },
  { name: 'eggs', group: 'protein', tokens: ['eggs'] },
  { name: 'tofu', group: 'protein', tokens: ['soy'], regions: ['east_asian', 'chinese'] },
  { name: 'tempeh', group: 'protein', tokens: ['soy'], regions: ['east_asian', 'chinese'] },
  ...
  // Grains
  { name: 'white rice', group: 'grain', tokens: ['grains', 'starchy', 'refined_carbs'], regions: ['east_asian', 'chinese', 'south_asian', 'latin'] },
  ...
  { name: 'pasta', group: 'grain', tokens: ['wheat', 'gluten', 'grains', 'starchy'], regions: ['mediterranean', 'european'] },
  ...
  { name: 'sesame oil', group: 'oil', tokens: ['sesame'], regions: ['east_asian', 'chinese'] },
...
export const REGIONS: Record<Region, RegionInfo> = {
  ...
  chinese: { region: 'chinese', label: 'Chinese', hint: 'Lean into Chinese flavors: wok stir-fries, soy and ginger, garlic, scallion, steamed rice.' },
  ...
  american: { region: 'american', label: 'American', hint: 'Lean into American comfort flavors: roasts, grilled meats, hearty sides, simple seasoning.' },
  european: { region: 'european', label: 'European', hint: 'Lean into European flavors: braises, butter and herbs, root vegetables, rustic breads.' },
